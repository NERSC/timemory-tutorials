...
#----------------------------------------------------------------------------------------#
# macro ADD_SUBPROJECT()
#          Does a git submodule update + add_subdirectory
#
MACRO(ADD_SUBPROJECT PACKAGE_NAME)
    ...
    if("${PACKAGE_NAME}" IN_LIST PROJECTS)
        ...
        if(NOT EXISTS "${PROJECT_SOURCE_DIR}/${PACKAGE_DIRECTORY}/CMakeLists.txt")
            message(STATUS "Warning! '${PROJECT_SOURCE_DIR}/${PACKAGE_DIRECTORY}/CMakeLists.txt' does not exist!")
        else()
